...
//                   QString info= "port" + QString (m_nPort) + " OnSockStateChanged 0 and reconnect!!!";
//                   log_singleton::Write_Log(info, Log_Level::Urgent);
                }
            }
        }
    }
    else if (QAbstractSocket::ConnectedState == state)
    {
        ...
        {            
            ...
            // QString info= "port" + QString (m_nPort) + " connected";
