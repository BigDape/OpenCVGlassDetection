...
public:
    /**
     * @brief getInstance 单例对象获取接口
     * @return 单例对象
     */
    static GlobalParamter& getInstance();

    /**
     * @brief GetParamterFromIniFile 从ini文件中获取参数key对应的字符串值
     * @param fullpath ini文件的路径
     * @param key 关键值
     * @return value 关键值对应的值
     */
    QString GetParamterFromIniFile(QString fullpath, QString key);

    /**
     * @brief SetParamterIntoIniFile 设置参数key和值vale到ini文件中
     * @param fullpath ini文件的路径
     * @param key key关键值
     * @param value value关键值
     */
    void SetParamterIntoIniFile(QString fullpath,
                                QString key,
                                QString value);

    /**
     * @brief cvMat2QImage cv::Mat图像转成QImage图像
     * @param mat cv::Mat图像
     * @return QImage图像
     */
    ...
    /**
     * @brief QImage2cvMat QImage图像转成cv::Mat图像
    ...
    /**
     * @brief ReassignValue 重新赋值设置参数
     * @param signalctrl 设置参数
     */
