...
#define ADDR1 0x0010        // "编码器参数.编码脉冲滤波";
#define ADDR15 0x0460       // "控制器系统参数.光电信号脉冲滤波";
#define ADDR18 0x0450       // "控制器系统参数.相机帧信号触发延时行数"
#define ADDR24 0x0024       // "光源控制器参数.光场1发光时间"
#define ADDR26 0x0028       // "光源控制器参数.光场2发光时间"
#define ADDR28 0x002C       // "光源控制器参数.光场3发光时间"
#define ADDR35 0x0048       // "光源控制器参数.相机与光场控制";
#define ADDR57 0x0014       // "编码器参数.压轮编码器A计数";
#define ADDR58 0x0018       // "编码器参数.压轮编码器B计数";
#define ADDR60 0x0030       // "控制器系统参数.拍照模式(0固定/1自动)";
#define ADDR61 0x0454       // "控制器系统参数.拍照结束延时行数";

// 新建变量
#define ADDR62 0x0844       // 压轮编码器四倍频计数
#define ADDR63 0x0464       // 编码数产生拍照脉冲，已经对编码进行四倍频
...
void SignalControlData::SetAllRegs(SignalControl data)
{
    ...
    m_pSig_comm.SetRegs(ADDR35, ADDR35, &data.LightCameraEnable);

    m_pSig_comm.SetRegs(ADDR60, ADDR60, &data.PhotoMode);
    m_pSig_comm.SetRegs(ADDR61, ADDR61, &data.TimelapseAfterPhotoShootEnd);

    //m_pSig_comm.SetRegs(ADDR62, ADDR62, &sigctrl->tempRoller4ABCount);//压轮编码器四倍频计数
...
void SignalControlData::GetAllData(SignalControl& data)
{
    ...
    //m_pSig_comm.GetRegs(ADDR62, ADDR62, &sigctrl->tempRoller4ABCount);
